...
type GrupoACCC471GarSCRComplexType struct {
	XMLName                     xml.Name                                `xml:"Grupo_ACCC471_GarSCR"`
...
type GrupoACCC471ImovelComplexType struct {
	XMLName               xml.Name                   `xml:"Grupo_ACCC471_Imovel"`
...
type GrupoACCC471GarFidejussoriaComplexType struct {
	XMLName                     xml.Name                                  `xml:"Grupo_ACCC471_GarFidejussoria"`
...
type GrupoACCC471GarFidjssriaPJComplexType struct {
	XMLName                   xml.Name                     `xml:"Grupo_ACCC471_GarFidjssriaPJ"` // Alinhado com o nome no XML
...
type GrupoACCC471GarFidjssriaPFComplexType struct {
	XMLName                   xml.Name            `xml:"Grupo_ACCC471_GarFidjssriaPF"` // Alinhando com o XML
	CodErroAttr               string              `xml:"CodErro,attr,omitempty"`
...
type GrupoACCC471VeicComplexType struct {
	XMLName                xml.Name                    `xml:"Grupo_ACCC471_Veic"`
